-- Active: 1744075936750@@127.0.0.1@3306
...
INSERT INTO orders (order_data, customer_id, price)
VALUES ('2023-07-15', 1, 50),
('2023-07-16', 2, 75),
('2023-07-17', 3, 30);

SELECT orders.order_id, customers.name, orders.order_data, orders.price 
